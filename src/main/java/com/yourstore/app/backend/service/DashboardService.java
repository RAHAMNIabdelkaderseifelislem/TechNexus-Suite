...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardMetrics() {
        ...
        metrics.put("profitLast7Days", salesLast7Days.subtract(purchasesLast7Days));
        ...
        metrics.put("profitLast30Days", salesLast30Days.subtract(purchasesLast30Days));

        // Weekly Performance Chart Data (Sales, Purchases, Profit)
        ...
        weeklySalesMap.forEach((day, sales) -> weeklyProfitMap.put(day, sales.subtract(weeklyPurchasesMap.getOrDefault(day, BigDecimal.ZERO))));
